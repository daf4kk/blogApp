...
const HomePage:React.FC<Props> = ({setIsLoged, isLoged}) => {
    ...
    return (
        <PageContainer setIsLoged={setIsLoged}>
            <div className='w-[95%] h-[1500px] mt-10 text-black relative' >
                <div className = 'carousel-blog w-[100%] h-[400px] bg-cyan-700 m-auto rounded-2xl absolute flex'>
                    <div className='blog-img w-[100%] rounded-2xl'>
                        <img src = {img1} alt = 'blog-img' className=' w-[100%] h-[400px] rounded-lg'></img>
                    </div>
                    <div className='blog-description p-5 h-[350px] absolute'>
                        <h1 className='font-bold text-4xl 2xl:text-2xl xl:text-xl lg:text-xl'>Сколько котиков можно трахнуть за один раз</h1>
                        ...
                        <div className="buttons absolute right-5 bottom-0">
                            <button className='blog-button  bg-green-300 text-zinc-800 hover:text-white'>Добавить в избранное</button>
                            {/* <button className='blog-button bg-red-400 text-zinc-800 hover:text-white'>Удалить из избранного</button> */}
                            <button className='ml-5 blog-button  bg-cyan-600 hover:text-cyan-400'>Читать полностью</button>
                        </div>
                    </div>
